...
while True:
    ...
    if len(lmList) != 0:
        ...
        elif (lmList[tipIDs[0]][1] < lmList[baseJointIDs[0]][1]) and (lmList[tipIDs[0]][1] > lmList[baseJointIDs[2]][1]) and (lmList[tipIDs[0]][2] < lmList[baseJointIDs[1]][2]) and (lmList[tipIDs[0]][2] < lmList[midFingerIDs[0]][2]) and (lmList[tipIDs[1]][2] < lmList[midFingerIDs[1]][2]) and (lmList[tipIDs[2]][2] < lmList[midFingerIDs[2]][2]) and (lmList[tipIDs[3]][2] < lmList[midFingerIDs[3]][2]) and (lmList[tipIDs[4]][2] < lmList[midFingerIDs[4]][2]):
            cv2.putText(img, str('B'), (30, 70), cv2.FONT_HERSHEY_SIMPLEX, 3, (255, 0, 255), 3)

        # used if user makes an 'C'
        elif (lmList[tipIDs[0]][1] < lmList[midFingerIDs[0]][1]) and (lmList[midFingerIDs[0]][1] > lmList[baseJointIDs[1]][1]) and (lmList[tipIDs[1]][2] > lmList[upperMidIds[1]][2]) and (lmList[tipIDs[2]][2] > lmList[upperMidIds[2]][2]) and (lmList[tipIDs[3]][2] > lmList[upperMidIds[3]][2]) and (lmList[tipIDs[4]][2] > lmList[upperMidIds[4]][2]) and (lmList[tipIDs[1]][2] < lmList[baseJointIDs[1]][2]) and (lmList[tipIDs[2]][2] < lmList[baseJointIDs[2]][2]) and (lmList[tipIDs[3]][2] < lmList[baseJointIDs[3]][2]) and (lmList[tipIDs[4]][2] < lmList[baseJointIDs[4]][2]):
            cv2.putText(img, str('C'), (30, 70), cv2.FONT_HERSHEY_SIMPLEX, 3, (255, 0, 255), 3)

        # used if user makes an 'D'
        elif (lmList[tipIDs[0]][1] < lmList[baseJointIDs[0]][1]) and (lmList[tipIDs[0]][2] < lmList[midFingerIDs[0]][2]) and (lmList[tipIDs[0]][2] > lmList[midFingerIDs[2]][2]) and (lmList[tipIDs[1]][2] < lmList[upperMidIds[1]][2]) and (lmList[tipIDs[2]][2] > lmList[midFingerIDs[2]][2]) and (lmList[tipIDs[3]][2] > lmList[midFingerIDs[3]][2]) and (lmList[tipIDs[4]][2] > lmList[midFingerIDs[4]][2]):
            cv2.putText(img, str('D'), (30, 70), cv2.FONT_HERSHEY_SIMPLEX, 3, (255, 0, 255), 3)

        # used if user makes an 'E'
        elif (lmList[tipIDs[0]][1] < lmList[baseJointIDs[0]][1]) and (lmList[tipIDs[0]][2] < lmList[midFingerIDs[0]][2]) and (lmList[tipIDs[0]][2] > lmList[midFingerIDs[2]][2]) and (lmList[tipIDs[1]][2] > lmList[midFingerIDs[1]][2]) and (lmList[tipIDs[2]][2] > lmList[midFingerIDs[2]][2]) and (lmList[tipIDs[3]][2] > lmList[midFingerIDs[3]][2]) and (lmList[tipIDs[4]][2] > lmList[midFingerIDs[4]][2]):
            cv2.putText(img, str('E'), (30, 70), cv2.FONT_HERSHEY_SIMPLEX, 3, (255, 0, 255), 3)

        # used if user makes an 'F'
        elif (lmList[tipIDs[0]][1] < lmList[midFingerIDs[0]][1]) and (lmList[tipIDs[1]][2] > lmList[midFingerIDs[1]][2]) and (lmList[tipIDs[1]][2] > lmList[upperMidIds[1]][2]) and (lmList[tipIDs[2]][2] < lmList[midFingerIDs[2]][2]) and (lmList[tipIDs[3]][2] < lmList[midFingerIDs[3]][2]) and (lmList[tipIDs[4]][2] < lmList[midFingerIDs[4]][2]):
